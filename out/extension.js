...
function activate(context) {
    ...
    const hoverProviderDisposable = vscode.languages.registerHoverProvider('*', // Register for all file types
    ...
    const openSvgContentDisposable = vscode.commands.registerCommand('svg.openSvgContent', async (args) => {
    ...
    const openSvgFileDisposable = vscode.commands.registerCommand('svg.openSvgFile', async (args) => {
    ...
    context.subscriptions.push(hoverProviderDisposable, formattingProviderDisposable, openSvgContentDisposable, openSvgFileDisposable);
}
/**
...
class SvgHoverProvider {
     ...
     */
    checkForSvgTag(document, position) {
     ...
     */
    checkForSvgFileReference(document, position, word) {
     ...
     */
    createSvgTagHover(svgContent, range) {
...
`;
     ...
     * @returns A hover object with SVG preview
     */
    createSvgFileHover(filePath, range, documentUri) {
